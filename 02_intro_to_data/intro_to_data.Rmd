...
Let's load the packages. The openintro package that we need is a development package
so we need to install the **devtools** package and then use `install_github` command to 
